        ...
        const DBoardMain = function (header, content, footer) {
            ...
            const pr_DATA_CTRL = {
                ...
                [App.router.part.VI_AUT_STD]: {
                    ...
                    initParams : [null, "#div_main_content", null, "AutStd"],
                    fInit: "do_lc_init",
                    fInitParams: [],
                    fShow      : "do_lc_show",
                    fShowParams: [],
                ...
                [App.router.part.VI_AUT_EMP]: {
                    nameGroup  : "Aut",
                    name       : "AutEmp",
                    path       : "group/aut/emp/ctrl/Main",
                    initParams : [null, "#div_main_content", null, "AutEmp"],
                    fInit: "do_lc_init",
                    fInitParams: [],
                    fShow      : "do_lc_show",
                    fShowParams: [],
