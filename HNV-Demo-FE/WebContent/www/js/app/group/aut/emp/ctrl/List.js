define([
        'jquery',
        'text!group/aut/emp/tmpl/List.html',
        'text!group/aut/emp/tmpl/List_Typ_Adm.html' ,
        'text!group/aut/emp/tmpl/List_Typ_Agent.html' ,
        'text!group/aut/emp/tmpl/List_Typ_Cand.html' ,
        'text!group/aut/emp/tmpl/List_Typ_Recr.html' ,
        ],
        function($, 
        		Tmpl_List,
        		Tmpl_List_Typ_Adm,
	...
	var CtrlList 	= function (header, content, footer, grpName) {
		...
		//------------------------------------------------------------------------------------
		var pr_SERVICE_CLASS		= "ServiceMatEmp"; //to change by your need
