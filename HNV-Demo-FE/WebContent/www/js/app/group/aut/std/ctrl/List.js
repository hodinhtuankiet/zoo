define([
        'jquery',
        'text!group/aut/std/tmpl/List.html',
        'text!group/aut/std/tmpl/List_Typ_Adm.html' ,
        'text!group/aut/std/tmpl/List_Typ_Agent.html' ,
        'text!group/aut/std/tmpl/List_Typ_Cand.html' ,
        'text!group/aut/std/tmpl/List_Typ_Recr.html' ,
        ],
        function($, 
        		Tmpl_List,
        		Tmpl_List_Typ_Adm,
